...
public class viewculture extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewculture);
        lst = findViewById(R.id.listview);
        db = openOrCreateDatabase("database3.db", Context.MODE_PRIVATE, null);
        Cursor c = db.query("leader3", null, null, null, null, null, null);
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent in=new Intent(getApplicationContext(),viewculsec.class);
    ...
    public void click(View v){
        Intent in=new Intent(viewculture.this, voting3.class);
        startActivity(in);
