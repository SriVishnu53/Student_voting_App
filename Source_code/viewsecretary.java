...
public class viewsecretary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewsecretary);
        btn = findViewById(R.id.but);
        lst = findViewById(R.id.listview);
        db = openOrCreateDatabase("database1.db", Context.MODE_PRIVATE, null);
        Cursor c = db.query("leader1", null, null, null, null, null, null);
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent in = new Intent(getApplicationContext(), viewsectary.class);
        ...
        public void click(View v){
            Intent in=new Intent(viewsecretary.this, voting1.class);
            startActivity(in);
