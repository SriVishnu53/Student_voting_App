...
public class joinsec extends AppCompatActivity {
    EditText e1, e2, e3;
    Button b1, b2, b3;
    DBHandler2 db;
    SQLiteDatabase sq;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_joinsec);
    ...
    public void Update(View view) {
        ...
        if ( reg.equals("") ) {
            ...
            values.put("Reg_NO", reg);
            values.put("MObile_NO", mobile);
            sq.update("leader2", values,"Reg_NO="+reg,null);
    ...
    public void Delete(View view) {
        ...
        if ( reg.equals("") ) {
            ...
            sq.delete("leader2", "Reg_NO="+reg,null);
