...
public class voting3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DBC = new Dbsectrayvote3(this);
        b1 = findViewById(R.id.vtn);
        help2= new DBHelper(this);
        // Open or create your SQLite database
        db = openOrCreateDatabase("database3.db", Context.MODE_PRIVATE, null);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkstuname==false)  {
                    Toast.makeText(voting3.this, "Voter_id does not exist", Toast.LENGTH_SHORT).show();
                } else {
                    if (Voter_id.equals("") || Candidate_id.equals("")) {
                        Toast.makeText(voting3.this, "Enter all the fields", Toast.LENGTH_SHORT).show();
                    } else {
                        Boolean insertData = DBC.insertData(Voter_id, Candidate_id);
                        if (insertData == true) {
                            Toast.makeText(voting3.this, "Voted Successful", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(voting3.this, "Vote Not Successfull", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            }
    ...
    private List<String> fetchRegNumbersFromDatabase() {
        ...
        Cursor cursor = db.query("leader3", null, null, null, null, null, null);
