...
public class viewjoin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewjoin);
        lst = findViewById(R.id.listview);
        db = openOrCreateDatabase("database2.db", Context.MODE_PRIVATE, null);
        Cursor c = db.query("leader2", null, null, null, null, null, null);
        ...
        lst.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent in=new Intent(getApplicationContext(),viewjoinsec.class);
    ...
    public void click(View v){
        Intent in=new Intent(viewjoin.this, voting2.class);
        startActivity(in);
